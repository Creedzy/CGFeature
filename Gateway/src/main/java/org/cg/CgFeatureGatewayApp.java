...
import org.cg.config.DefaultProfileUtil;
...
@EnableZuulProxy
public class CgFeatureGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(CgFeatureGatewayApp.class);

    private final Environment env;

    public CgFeatureGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes CGFeatureGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CgFeatureGatewayApp.class);
