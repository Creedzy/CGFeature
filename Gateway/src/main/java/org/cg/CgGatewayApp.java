...
public class CgGatewayApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(CgGatewayApp.class);

    private final Environment env;

    public CgGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes CGGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CgGatewayApp.class);
