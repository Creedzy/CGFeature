package org.cg.common.service.impl;
...
import org.cg.common.exception.EncryptionException;
import org.cg.common.service.EncryptionService;
...
public class EncryptionServiceImpl implements EncryptionService{
    ...
    public EncryptionServiceImpl(String key) throws NoSuchAlgorithmException, NoSuchPaddingException {
        secretKey = new SecretKeySpec(key.getBytes(),"AES");
        secretKeyChar = key.toCharArray();
